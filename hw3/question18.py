...
from hw3.utilities import train_by_gradient_descent, full_gradient_descent_theta, one_zero_error, test_data_from_hypothesis
...
def main():
    ...
    weight_score_full_gradient = train_by_gradient_descent(features, tags, full_gradient_descent_theta, eta, UPDATE_TIMES)
